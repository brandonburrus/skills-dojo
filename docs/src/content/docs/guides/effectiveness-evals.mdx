...
skills/
  sql-queries/
    SKILL.md
    evals/
      selection.yaml         # selection evals (optional)
...
variants:
  - name: verbose-instructions
    skill_file: variants/verbose.md
...
Criterion names should be descriptive -- the judge uses them (along with golden material) to understand what to evaluate.
...
variants:
  - name: detailed-examples
    skill_file: variants/detailed.md
  - name: minimal
    skill_file: variants/minimal.md
...
dojo run --judge anthropic/claude-opus-4-20250514
